...
Cenário: Cadastro de dog walker com sucesso
    [Tags]    happy_path
    Preencher Dados Pessoais         Kelly Fiochi    kelly@email.com    12345678901    12345-678    200    Apt 42
...
Cenário: CPF incorreto
    [Tags]    invalid_cpf
    Preencher Dados Pessoais        Kelly Fiochi     kelly@email.com    1234567890a    12345-678    200    Apt 42
    Submeter Formulário de Cadastro
    Verificar Mensagem de Alerta    CPF inválido

Cenário: Email incorreto
    [Tags]    invalid_email
    Preencher Dados Pessoais        Kelly Fiochi     kelly.com    12345678333    12525-678    200    Apt 42
    Submeter Formulário de Cadastro
